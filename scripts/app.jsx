...
const BalancesTable = () => {
  ...
  return (
  <table className="lightblue_on_blue h20px darkgray_border bordered">
    <tbody>
...
const SendFromSeedIxField = () => {
  ...
  // mainConsole.log('SendFromSeedIxField', accountBook);
  if(accountBook[0]) {
      ...
      <table className="w800h600px no_padding no_border">
        <tbody>
          <tr className="no_padding">
            <td className="valign_top lightblue_on_blue no_border" style={{
                width: '150px'
              }}>
              <table className="w100pct no_border">
                <tbody>
                  ...
                  <tr>
                    <td className="lightblue_on_blue h20px no_border"></td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td id='representatives' className="lightblue_on_blue_with_hover h20px fake_button"
                  ...
                  <tr>
                    <td id='accounts' className="lightblue_on_blue_with_hover h20px fake_button"
                  ...
                  <tr>
                    <td className="lightblue_on_blue h200px no_border"></td>
                  </tr>
                  <tr>
                    <td className="lightblue_on_blue_with_hover h20px fake_button"
              ...
              <table className="w590px no_border no_padding">
                <tbody>
                  ...
                  <tr id="update-representative">
                    <td className="lightblue_on_blue h20px darkgray_border bordered">
                      <div className="gray_on_yellow"><Localization name="newRepresentative"/> (nano_ <Localization name="or"/> camo_)</div>
                      <br/>
                            ...
                            return (
                              <tbody key={index}>
                                ...
                                <tr>
                                  ...
                                  <td className="no_border no_padding">{item.nano}</td>
                                  <td className="no_border no_padding">{item.nanoshi}</td>
                  ...
                  <tr id="send-spacer-01">
                    <td className="lightblue_on_blue h200px no_border">
                  ...
                  <tr id="to-account-is-camo">
                    <td className="lightblue_on_blue h120px darkgray_border bordered">
                      <UseCamoButton/>
                    </td>
                  </tr>
                  <tr id="account-book">
